public class EditDistance {
    public static int editDistance(String s, String t){   //recursive very slow
        if(s.length()==0){
            return t.length();
        }
        if(t.length()==0){
    ...
    public static int editDistanceM(String s, String t){    //memoization fast af
         int m=s.length();
         int n=t.length();
    ...
    public static int editDistanceDP(String s, String t){    //dp
        int m=s.length();
        int n=t.length();
        int storage[][]=new int [m+1][n+1];
    ...
    public static void main(String[] args) {
        String s="adededefadedadedede";
        String t="gbddegbddgbddef";
        System.out.println(editDistanceDP(s, t));  //fast af
        System.out.println(editDistanceM(s, t));
        System.out.println(editDistance(s, t));  //very slow 
    } 
}
