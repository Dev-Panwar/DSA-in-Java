...
public class PQMax {    //Implementation Using Max heap.
    ...
    boolean isEmpty() {
        ...
        return heap.isEmpty(); //here isEmpty is inbuilt function of java to check whether an arraylist is empty pr not
    }

    int getSize() {
        // Implement the getSize() function here
        return heap.size(); //inbuilt function of arraylist to check size of arraylist
    }
